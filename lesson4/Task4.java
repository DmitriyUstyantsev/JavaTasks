...
public class Task4 {
    ...
    public static void main(String[] args) {
        ...
        String text = "";
        try {
            FileWriter fileWriter = new FileWriter("C:\\Users\\OMEN\\Documents\\java_projects\\lesson4\\db.sql");
             
            fileWriter.append("Иванов Иван Иванович 36 М\n");
            fileWriter.append("Смирнова Татьяна Петровна 25 Ж\n");
            fileWriter.append("Колтышв Вадим Сергеевич 52 М\n");  
            fileWriter.append("Кунцев Дмитрий Андреевич 26 М\n");
            fileWriter.append("Петрова Татьяна Викторовна 22 Ж\n");
            fileWriter.append("Герасимов Виктор Николаевич 33 М\n");
            fileWriter.append("Резникова Наталья Игоревна 43 Ж\n"); 
            
            fileWriter.flush();
            fileWriter.close();        
             
            FileReader fileReader = new FileReader("C:\\Users\\OMEN\\Documents\\java_projects\\lesson4\\db.sql");
            while ((fileReader.ready())) {
                text += (char) fileReader.read();
